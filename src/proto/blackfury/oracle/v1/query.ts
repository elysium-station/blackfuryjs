...
export class QueryClientImpl implements Query {
  ...
  ExchangeRate(request: QueryExchangeRateRequest): Promise<QueryExchangeRateResponse> {
    ...
    const promise = this.rpc.request("blackfury.oracle.v1.Query", "ExchangeRate", data);
  ...
  ExchangeRates(request: QueryExchangeRatesRequest): Promise<QueryExchangeRatesResponse> {
    ...
    const promise = this.rpc.request("blackfury.oracle.v1.Query", "ExchangeRates", data);
  ...
  Actives(request: QueryActivesRequest): Promise<QueryActivesResponse> {
    ...
    const promise = this.rpc.request("blackfury.oracle.v1.Query", "Actives", data);
  ...
  VoteTargets(request: QueryVoteTargetsRequest): Promise<QueryVoteTargetsResponse> {
    ...
    const promise = this.rpc.request("blackfury.oracle.v1.Query", "VoteTargets", data);
  ...
  Targets(request: QueryTargetsRequest): Promise<QueryTargetsResponse> {
    ...
    const promise = this.rpc.request("blackfury.oracle.v1.Query", "Targets", data);
  ...
  FeederDelegation(request: QueryFeederDelegationRequest): Promise<QueryFeederDelegationResponse> {
    ...
    const promise = this.rpc.request("blackfury.oracle.v1.Query", "FeederDelegation", data);
  ...
  MissCounter(request: QueryMissCounterRequest): Promise<QueryMissCounterResponse> {
    ...
    const promise = this.rpc.request("blackfury.oracle.v1.Query", "MissCounter", data);
  ...
  AggregatePrevote(request: QueryAggregatePrevoteRequest): Promise<QueryAggregatePrevoteResponse> {
    ...
    const promise = this.rpc.request("blackfury.oracle.v1.Query", "AggregatePrevote", data);
  ...
  AggregatePrevotes(request: QueryAggregatePrevotesRequest): Promise<QueryAggregatePrevotesResponse> {
    ...
    const promise = this.rpc.request("blackfury.oracle.v1.Query", "AggregatePrevotes", data);
  ...
  AggregateVote(request: QueryAggregateVoteRequest): Promise<QueryAggregateVoteResponse> {
    ...
    const promise = this.rpc.request("blackfury.oracle.v1.Query", "AggregateVote", data);
  ...
  AggregateVotes(request: QueryAggregateVotesRequest): Promise<QueryAggregateVotesResponse> {
    ...
    const promise = this.rpc.request("blackfury.oracle.v1.Query", "AggregateVotes", data);
    return promise.then((data) => QueryAggregateVotesResponse.decode(new _m0.Reader(data)));
  }

  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    const data = QueryParamsRequest.encode(request).finish();
    const promise = this.rpc.request("blackfury.oracle.v1.Query", "Params", data);
