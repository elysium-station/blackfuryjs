...
export interface BlackfuryClientOptions extends SigningStargateClientOptions {
...
export class BlackfuryClient extends StargateClient {
  ...
  public static override async connect(
    ...
    options: BlackfuryClientOptions = {},
  ): Promise<BlackfuryClient> {
    const tmClient = await Tendermint34Client.connect(endpoint);
    return new BlackfuryClient(tmClient, undefined, options);
  }
  ...
  public static async connectWithSigner(
    ...
    const tmClient = await Tendermint34Client.connect(endpoint);
    return new BlackfuryClient(tmClient, signer, options);
  }
  ...
  public static async offline(
    ...
    return new BlackfuryClient(undefined, signer, options);
  }
  ...
  protected constructor(
    ...
    options = {
      ...
      prefix: options.prefix ?? "black",
      aminoTypes: options.aminoTypes ?? createDefaultAminoTypes(options.prefix ?? "black"),
