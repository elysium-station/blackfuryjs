...
export class DirectEthSecp256k1Wallet implements OfflineDirectSigner {
   ...
   * @param prefix The bech32 address prefix (human-readable part). Defaults to "black".
   */
  public static async fromKey(privkey: Uint8Array, prefix = "black"): Promise<DirectEthSecp256k1Wallet> {
  ...
  private get address(): string {
    ...
    return toBech32(this.prefix, rawEthSecp256k1PubkeyToRawAddress(uncompressed));
  }
